  ...
  <div class="d-flex justify-content-center" >
    ...
    <div  style="width: 350px;">
      ...
      <div class=" d-flex justify-content-between text-white" style="font-size : 20px ">
          ...
          <RouterLink   style="font-size : 50px ; border-radius: 10px;" class="p-2" :class="{'bg-success' :underline_inventory}" @click="setUnderline(4)" to="/MyInventory">&nbsp;&nbsp;<i class=" bi bi-backpack4"></i>&nbsp;&nbsp;</RouterLink>    
