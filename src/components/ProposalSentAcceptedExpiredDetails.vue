    ...
    <div class="d-flex justify-content-between"> 
     <div>
      ...
      <i  @click="$emit('closeModal')" class="display-1 bi bi-x-lg"></i>  
        ...
        <p style="font-size:20px" class="text-center" > Intercambio Expirado</p>
        <p class="text-center">
            <i style="font-size:60px"  class="bi bi-cash"></i> 
        </p>

       <br>
        
        <p class="text-center">
          Si bien el usuario <b> {{offer.dest_owner_name}} </b> acepto el intercambio, Tu no concreateste el pago del Despacho y Retiro de los objetos<br>
        </p>
