...
<template>
 ...
 <div>
    ...
    <div class="border border-1 rounded text-white border-secondary" >

        <div class="d-flex justify-content-between">
            <div class="m-1" >
                 Intercambio Finalizado Exitoso con <b> {{offer.dest_owner_name}}</b> <br>
                 {{offer.title}}  
            </div>

            <div>
                <i style="font-size:36px" class=" text-success bi bi-check-lg m-0"></i>
            </div>
