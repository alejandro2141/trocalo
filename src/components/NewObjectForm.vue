  ...
  <div>
    ...
    <div class="d-flex flex-wrap w-100">
      ...
      <div @click="$refs.show_uploadPicture_1_input.click()" style="width:200px; height:200px ; border-radius:15px" class="bg-dark border m-1 text-center">
          ...
          <input ref="show_uploadPicture_1_input" type="file" accept="image/*;capture=camera" capture="camera" @change='uploadImage_1' style="display: none">
          <br>
      ...
      <div @click="$refs.show_uploadPicture_2_input.click()" style="width:100px; height:100px ; border-radius:15px" class="bg-dark border m-1 text-center">
          ...
          <input ref="show_uploadPicture_2_input" type="file" accept="image/jpeg;capture=camera" capture="camera" @change='uploadImage_2' style="display: none">
      </div>
      ...
      <div @click="$refs.show_uploadPicture_3_input.click()" style="width:100px; height:100px ; border-radius:15px" class="bg-dark border m-1 text-center">
          ...
          <input ref="show_uploadPicture_3_input" type="file" accept="image/jpeg;capture=camera" capture="camera" @change='uploadImage_3' style="display: none">
      </div>
      ...
      <div @click="$refs.show_uploadPicture_4_input.click()" style="width:100px; height:100px ; border-radius:15px" class="bg-dark border m-1 text-center">
          ...
          <input ref="show_uploadPicture_4_input" type="file" accept="image/jpeg;capture=camera" capture="camera" @change='uploadImage_4' style="display: none">
      </div>
      ...
      <div @click="$refs.show_uploadPicture_5_input.click()" style="width:100px; height:100px ; border-radius:15px" class="bg-dark border m-1 text-center">
          ...
          <input ref="show_uploadPicture_5_input" type="file" accept="image/jpeg;capture=camera" capture="camera" @change='uploadImage_5' style="display: none">
      </div>
