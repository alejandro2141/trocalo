...
<div  style="" class="m-0"   >
    ...
    <text @click="$emit('filterByCategory',4)" style="font-size: 25px;" > Vestuario <i class="bi bi-caret-right-fill"></i> </text>
    <br>
...
created() {
    ...
    console.log("APP CREATED : Search Categories Objects :"+JSON.stringify(this.objects))
    },
