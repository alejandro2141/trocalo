...
<!-- OF SENT -->
    ...
    <div v-for="of in ofReceived"  > 
        <OfReceivedItem  class="m-1" @click="showExchangeProposalSent=true"  :offer='of'  />
    </div>
<!-- OF SENT -->
...
<!-- OF SENT ACCEPTED -->
    ...
    <div v-for="of in ofAccepted"  > 
        <OfReceivedItem  class="m-1" :accepted='true' @click="showExchangeProposalSentAccepted=true"  :offer='of'  />
    </div>
<!-- OF SENT ACCEPTED -->
...
<!-- OF SENT ENDED -->
    ...
    <div class="text-secondary">
      <div v-for="of in ofEnded"  > 
        <OfReceivedItem  class="m-1" @click="showExchangeProposalSentEnded=true"  :offer='of'  />
      </div>
    </div>
<!-- OF SENT ENDED -->
